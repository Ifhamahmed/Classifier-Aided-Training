...
import argparse
import pandas as pd
from Models import UNET_ORIG, FCN_ORIG
...
image = cv2.imread('/home/ifham_fyp/PycharmProjects/stuttgart_00/stuttgart_00_000000_000205_leftImg8bit.png')
output = image.copy()
...
model = UNET_ORIG.build((512, 512, 3), 29, pretrained_weights='UNET_FIN/Checkpoint_Weights.h5')
...
label_map = np.zeros((preds.shape[0], preds.shape[1], 3)).astype('uint8')
